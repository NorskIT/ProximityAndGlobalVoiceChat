...
internal static class KissFFT
{
	...
	internal static void kf_bfly4(int[] Fout, int fout_ptr, int fstride, FFTState st, int m, int N, int mm)
	{
		if (m == 1)
		{
			for (int i = 0; i < N; i++)
	...
	internal static void kf_bfly3(int[] Fout, int fout_ptr, int fstride, FFTState st, int m, int N, int mm)
	{
		int num = 2 * m;
		int num2 = 4 * m;
		int num3 = fout_ptr;
	...
	internal static void kf_bfly5(int[] Fout, int fout_ptr, int fstride, FFTState st, int m, int N, int mm)
	{
		int num = fout_ptr;
		short b = 10126;
		short b2 = -31164;
