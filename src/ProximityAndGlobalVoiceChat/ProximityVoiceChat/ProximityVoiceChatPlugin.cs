...
[BepInPlugin("NorskIT.ProximityAndGlobalVoiceChat", "ProximityAndGlobalVoiceChat", "0.2.2")]
...
public class ProximityVoiceChatPlugin : BaseUnityPlugin
{
	...
	{
		Instance = this;
        Log.LogInfo("ProximityAndGlobalVoiceChat 0.2.2 - local fork of Azumatt ProximityVoiceChat 1.0.2");
		Localizer.Load();
